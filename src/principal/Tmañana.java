 ...
 */
public class Tmañana extends javax.swing.JFrame {

    private List<Estudiante> estudiantes = new ArrayList<Estudiante>();
    private DefaultListModel listaEstudiantes = new DefaultListModel();
    
    private Tturnos pturnos;
    /**
     * Creates new form Tmañana
     */
    public Tmañana() {
        initComponents();
    }
    
      public Tmañana(Tturnos pturnos) {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        EditMañana pantalla = new EditMañana(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tmañana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
