 ...
 */
public class EditNoche extends javax.swing.JFrame {

    private Tnoche padre;
    
    /**
     * Creates new form EditNoche
     */
    public EditNoche() {
        initComponents();
    }
    
    public EditNoche(Tnoche padre) {
        initComponents();
        this.padre = padre;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditNoche.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
