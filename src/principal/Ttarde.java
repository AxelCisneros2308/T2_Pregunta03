 ...
 */
public class Ttarde extends javax.swing.JFrame {

    private List<Estudiante> estudiantes = new ArrayList<Estudiante>();
    private DefaultListModel listaEstudiantes = new DefaultListModel();
    
    private Tturnos ptarde;
    /**
     * Creates new form Ttarde
     */
    public Ttarde() {
        initComponents();
    }
    
    public Ttarde(Tturnos ptarde) {
        initComponents();
        this.ptarde = ptarde;
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        EditTarde pantalla = new EditTarde(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ttarde.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
