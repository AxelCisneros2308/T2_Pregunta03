 ...
 */
public class EditMañana extends javax.swing.JFrame {

    private Tmañana padre;
     String [] asistencias = new String [3];
    /**
     * Creates new form EditMañana
     */
    public EditMañana() {
        initComponents();
    }
    
    public EditMañana(Tmañana padre) {
        initComponents();
        this.padre = padre;
        cbAsistencia.addItem("ASISTIO");
        cbAsistencia.addItem("TARDANZA");
        cbAsistencia.addItem("FALTO");
        asistencias [0] = "ASISTIO";
        asistencias [1] = "TARDANZA";
        asistencias [2] = "FALTO";
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Trigonometría");

        jLabel2.setText("Nombre:");

        jLabel3.setText("Apellido:");

        cbAsistencia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ASISTIO", "TARDANZA", "FALTO" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       int index = this.cbAsistencia.getSelectedIndex();
       String asistencia = this.asistencias [index]; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMañana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMañana().setVisible(true);
            }
        });
    }
